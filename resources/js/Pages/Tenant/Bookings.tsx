                                ...
                                <tr key={b.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                    ...
                                    <td className="p-3">
                                        <div className="flex items-center justify-center gap-1">
                                            {b.status==='pending' && <><button onClick={()=>act(b.id,'approved')} className="h-7 px-2 text-[10px] font-bold bg-emerald-500 text-white rounded-lg">Terima</button><button onClick={()=>act(b.id,'rejected')} className="h-7 px-2 text-[10px] font-bold bg-red-500 text-white rounded-lg">Tolak</button></>}
