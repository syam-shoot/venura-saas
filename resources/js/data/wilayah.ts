export const provinces: Record<string, string[]> = {
    ...
    'Sumatera Utara': [
        ...
        'Kota Padang Sidempuan', 'Kota Pematangsiantar', 'Kota Sibolga', 'Kota Tanjungbalai',
        'Kota Tebing Tinggi',
    ],
    'Sumatera Barat': [
    ...
    'Sumatera Selatan': [
        ...
        'Kab. Penukal Abab Lematang Ilir', 'Kota Lubuklinggau', 'Kota Pagar Alam', 'Kota Palembang',
        'Kota Prabumulih',
    ],
    'Bengkulu': [
    ...
    'Kalimantan Selatan': [
        ...
        'Kab. Tanah Bumbu', 'Kab. Tanah Laut', 'Kab. Tapin', 'Kota Banjarbaru',
        'Kota Banjarmasin',
    ],
    'Kalimantan Timur': [
    ...
    'Sulawesi Tenggara': [
        ...
        'Kab. Muna', 'Kab. Muna Barat', 'Kab. Wakatobi', 'Kota Baubau',
        'Kota Kendari',
    ],
    'Gorontalo': [
    ...
    'Papua Barat': [
        ...
        'Kab. Pegunungan Arfak', 'Kab. Teluk Bintuni', 'Kab. Teluk Wondama', 'Kab. Asmat',
        'Kab. Boven Digoel', 'Kab. Mappi', 'Kab. Merauke', 'Kab. Deiyai',
        'Kab. Dogiyai', 'Kab. Intan Jaya', 'Kab. Mimika', 'Kab. Nabire',
        'Kab. Paniai', 'Kab. Puncak', 'Kab. Puncak Jaya', 'Kab. Jayawijaya',
        'Kab. Lanny Jaya', 'Kab. Mamberamo Tengah', 'Kab. Nduga', 'Kab. Pegunungan Bintang',
        'Kab. Tolikara', 'Kab. Yalimo', 'Kab. Yahukimo', 'Kab. Maybrat',
        'Kab. Raja Ampat', 'Kab. Sorong', 'Kab. Sorong Selatan', 'Kab. Tambrauw',
        'Kota Sorong',
    ],
};
